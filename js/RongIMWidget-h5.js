            ...
            qiniuuploader = Qiniu.uploader({
                ...
                init: {
                    ...
                    'FileUploaded': function (up, file, info) {
                        ...
                        RongIMLib.RongIMClient.getInstance().getFileUrl(RongIMLib.FileType.IMAGE, file.target_name, file.name || '', {
